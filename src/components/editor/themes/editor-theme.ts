...
export const editorTheme: EditorThemeClasses = {
  ...
  paragraph: "editor-paragraph mb-0 leading-tight",
  ...
  text: {
    base: "editor-text leading-tight",
    bold: "font-bold",
  ...
  code: "EditorTheme__code bg-gray-50 border border-gray-200 rounded-lg p-4 font-mono text-sm overflow-x-auto whitespace-pre-wrap preserve-breaks",
  codeHighlight: {
